...
- [tree-sitter-cli](https://github.com/tree-sitter/tree-sitter) (probably through `cargo`, requires `libclang-dev` or similar to build)
- [ripgrep](https://github.com/BurntSushi/ripgrep#installation)
- [fd](https://github.com/sharkdp/fd#installation)
- [lazygit](https://github.com/jesseduffield/lazygit)
- [yazi](https://github.com/sxyazi/yazi) (optionally enables nvim integration)
